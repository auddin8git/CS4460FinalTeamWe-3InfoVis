...
d3.csv("use_these_shows.csv").then(function (data) {
  ...
  function updateChart() {
    ...
    .on("click", function (event, d) {
      ...
      const image = content ? content.image : "./images/ColorBars.png"; // Default image in the folder
      console.log(image)
  ...
  d3.select("#page6").on("click", function (event) {
    ...
    if (!isRectangle) {
      ...
      d3.select("#image-boxCOMPLEX").html(`<img src="./images/ColorBars.png" alt="Image for BLANK" style="width: 100%; border-radius: 8px; margin-top: 25px;"/>`);
    }
  });
...
const customContent = {
  ...
  "The Marvelous Mrs. Maisel": {
    ...
    image: "./images/MarvelousMrsMaisel.jpg"
  },
  "The Boys": {
