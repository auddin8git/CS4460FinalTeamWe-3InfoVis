...
const width = (920 - margin.left - margin.right) * scaleFactor; // normally 960
const height = (550 - margin.top - margin.bottom) * scaleFactor; // normally 500
...
d3.csv("specific_networks.csv").then(function (data) {
  ...
  d3.select("#year-slider-page5")
    ...
    .call(sliderRange)
    .selectAll(".tick line") // Select tick marks
    .style("stroke", "#636e72") // Set darker gray color

  d3.select("#year-slider-page5")
    .selectAll(".tick text") // Select tick marks
    .style("fill", "#636e72") // Set darker gray color
